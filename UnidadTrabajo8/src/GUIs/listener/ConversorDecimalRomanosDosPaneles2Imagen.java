...
public class ConversorDecimalRomanosDosPaneles2Imagen extends JFrame implements ActionListener {
	 ...
	 * Constructor
	 */
	public ConversorDecimalRomanosDosPaneles2Imagen() {
		panel1 = new JPanel();
		panel1.setLayout(new GridLayout(2, 3, 15, 10));
		panel1.add(new JLabel("Nº decimal", JLabel.CENTER));
		campo1 = new JTextField(10);
		panel1.add(campo1);
		
		panel2 = new JPanel();
		panel2.setLayout(new GridLayout(2, 3, 15, 10));
	...
	public static void main(String[] args) {
		// Creamos la clase
		ConversorDecimalRomanosDosPaneles2Imagen c = new ConversorDecimalRomanosDosPaneles2Imagen();
