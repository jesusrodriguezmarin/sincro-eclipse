...
public class AhorcadoBoletin extends JFrame implements ActionListener {
	...
	private ImageIcon[] imagenesAhorcado = new ImageIcon[6]; 

	/**
	 * Constructor
	 */
	public AhorcadoBoletin() {

		// Instanciamos objeto
		juego = new AhorcadoPOO(); 

		// Cargamos las imágenes
		String rutaBase = "C:/proyectos/img0.png";
		...
		// Lógica para el botón resolver
			...
			if (!pal.isEmpty()) {
				if (juego.resolver(pal)) {
					JOptionPane.showMessageDialog(this, "¡Has ganado!", "¡Enhorabuena!", JOptionPane.INFORMATION_MESSAGE);
	...
	private void actualizarPantalla() {
		...
		if (juego.isAcertada() || juego.getIntentos() >= juego.TOTAL_INTENTOS) {
			if (juego.isAcertada()) 
				...
				JOptionPane.showMessageDialog(this, "Has perdido. La palabra era", "¡Ohhh!", JOptionPane.ERROR_MESSAGE);
