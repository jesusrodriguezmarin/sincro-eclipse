...
public class AhorcadoPOO {
	...
	/**
	 * Genera una palabra a mostrar con tantos * como letras tenga la palabra
	 * acertar
	 * 
	 * @return String - palabra generada aleatoriamente
	 */
	 ...
	 * @return true si la letra está contenida en la palabra a acertar false si la
	 *         letra no está contenida en la palabra a acertar
	 */
	public boolean intentar(char letra) {
		...
		// Devolvemos false sino está en la palabra
		return false;
	}
