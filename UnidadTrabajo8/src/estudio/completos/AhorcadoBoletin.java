...
public class AhorcadoBoletin extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (palabraSecreta.indexOf(letraPulsada) >= 0) {
			...
			JOptionPane.showMessageDialog(this, "¡Bien! La letra '" + letraPulsada + "' se encuentra en la palabra.",
					"Acierto", JOptionPane.INFORMATION_MESSAGE);
		} else {
			// FALLO
			fallos++;
			lblImagen.setText("Intentos fallidos: " + fallos + " / " + MAX_FALLOS);
			JOptionPane.showMessageDialog(this, "Lo siento, la letra '" + letraPulsada + "' NO está.", "Fallo",
	...
	private void comprobarEstado() {
		if (!palabraVisible.contains("_")) {
			...
			JOptionPane.showMessageDialog(this,
					"GAME OVER. Te has quedado sin intentos.\nLa palabra era: " + palabraSecreta, "Fin del juego",
	...
	public static void main(String[] args) {
		new AhorcadoBoletin().setVisible(true);
	}
}