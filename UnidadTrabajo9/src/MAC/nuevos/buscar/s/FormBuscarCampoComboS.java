...
public class FormBuscarCampoComboS extends JFrame implements ActionListener {
	...
	private ConexBuscarCampoComboS con;

	public FormBuscarCampoComboS() {
		setLayout(null);

		lblTitulo = new JLabel("Buscador Avanzado de Proveedores:");
		...
		try {
			...
			if (e.getSource() == btnBuscar) {
				if (textoFiltro.isEmpty()) {
					...
					con = new ConexBuscarCampoComboS();
					con.obtenerConexion();
					
					String campoSeleccionado = comboCampos.getSelectedItem().toString();
					con.buscarProveedorPorCriterio(tabla, campoSeleccionado, textoFiltro);
	...
	public static void main(String[] args) {
		FormBuscarCampoComboS f = new FormBuscarCampoComboS();
